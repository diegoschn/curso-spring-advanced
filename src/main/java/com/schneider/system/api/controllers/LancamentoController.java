...
import com.schneider.system.api.dtos.LancamentoDto;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		log.info("Buscando lancamentos por ID do funcionário: {}", funcionarioId,pag);
	...
	/**
	 * 
	 * Converte um lancamentoDto para uma entidade Lançamento.
	 * 
	 * @param lancamentoDto
	 * @param result
	 * @return Lancamento
	...
	private Lancamento converterDtoParaLancamento(LancamentoDto lancamentoDto, BindingResult result) throws ParseException{
		...
		lancamento.setData(this.dataFormat.parse(lancamentoDto.getData()));
	...
	private LancamentoDto converterLancamentoDto(Lancamento lancamento) {
		...
		lancamentoDto.setData(this.dataFormat.format(lancamento.getData()));
	...
	public ResponseEntity<Response<String>> remover(@PathVariable("id") Long id){
		...
		if(!lancamento.isPresent()) {
			log.info("Erro ao remover devido a um lançamento ID: {} ser inválido.", id);
