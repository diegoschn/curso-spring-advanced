...
public class CadastroPFDto {
	...
	public void setQtdHorasAlmolco(Optional<String> qtdHorasAlmoco) {
	...
	public String toString() {
		return "FuncionarioDTO [id=" + id + ", nome=" + nome + ", email=" + email + ", senha=" + senha + ", cpf" + cpf 
				+ ", valorHora=" + valorHora + ", qtdHorasTrabalhoDia=" + qtdHorasTrabalhoDia + ", qtdHorasAlmolco="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CadastroPFDto other = (CadastroPFDto) obj;
		if (id == null) {
			if (other.id != null)
				return false;
